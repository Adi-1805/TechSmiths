...
const faqs = [
  {
    question: "Who can apply to SpeedUp?",
    answer:
  ...
  },
  {
    ...
    answer:
      "No, SpeedUp is completely free to participate. We provide all resources, mentorship, and facilities at no cost to selected participants.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "SpeedUp is an in-person event to maximize collaboration and networking. Remote participation is not available for this cohort.",
  },
  {
...
// Terms data
const terms = [
  "Participant selection is subject to review by the SpeedUp screening committee",
  ...
  "SpeedUp may use event photos/videos for promotional purposes",
...
export default function SpeedUpPage() {
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white">
      {/* Header */}
      <header className="sticky top-0 z-50 border-b border-[#333] bg-[#1a1a1a]/95 backdrop-blur">
      ...
      <section className="relative overflow-hidden px-6 py-24 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <p className="mb-2 text-lg text-gray-300 md:text-xl">
            ...
            <span className="font-semibold text-white">working prototype</span>
            {" within 7 days"}
          </p>
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mb-16 text-center text-gray-400">A structured journey from idea to validated prototype</p>

          <div className="relative" ref={timelineContainerRef}>
            {/* Vertical line */}
            <div className="absolute left-[27px] top-0 h-full w-0.5 bg-[#333] md:left-[31px]" />
              ...
              {timelineSteps.map((step, index) => {
                ...
                return (
                  <div key={step.day} className="relative flex gap-6">
                    ...
                    <div className="pt-2">
                      <span className="mb-1 inline-block rounded bg-[#333] px-2 py-0.5 text-xs text-gray-300">
                        {step.day}
                      </span>
                      <h3
                        className={`text-lg font-semibold transition-colors duration-300 ${isActive ? "text-white" : "text-gray-400"}`}
                      >
                        {step.title}
                      </h3>
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mb-12 text-center text-gray-400">Everything you need to turn your idea into reality</p>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {features.map((feature) => {
              ...
              return (
                <div
                  key={feature.title}
                  className="rounded-xl border border-[#333] bg-[#222] p-6 transition-colors hover:border-[#f97316]/30"
                >
      ...
      <section id="nomination-form" className="px-6 py-20">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mb-12 text-center text-gray-400">Fill in your details to apply for SpeedUp 2024</p>

          <form onSubmit={handleSubmit} className="space-y-8">
            {/* Personal Details */}
            <div className="rounded-xl border border-[#333] bg-[#222] p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    required
                    className="border-[#333] bg-[#1a1a1a] text-white placeholder:text-gray-500 focus:border-[#f97316]"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="flex">
                    <div className="flex items-center rounded-l-md border border-r-0 border-[#333] bg-[#1a1a1a] px-3 text-gray-400">
                      +91
                    </div>
                    <Input
                      type="tel"
                      ...
                      required
                      className="rounded-l-none border-[#333] bg-[#1a1a1a] text-white placeholder:text-gray-500 focus:border-[#f97316]"
                    />
                  </div>
                </div>
            ...
            <div className="rounded-xl border border-[#333] bg-[#222] p-6">
              ...
              <div className="space-y-6">
                <div>
                  <label className="mb-3 block text-sm text-gray-300">Are you a Solo Founder?</label>
                ...
                <div>
                  <label className="mb-3 block text-sm text-gray-300">Do you need a Co-Founder?</label>
                  <div className="flex gap-3">
                    <button
                      type="button"
            ...
            <div className="rounded-xl border border-[#333] bg-[#222] p-6">
              ...
              <div className="space-y-6">
                <div>
                  <label className="mb-3 block text-sm text-gray-300">Your Idea Is In</label>
                ...
                <div>
                  ...
                  >
                    <SelectTrigger className="border-[#333] bg-[#1a1a1a] text-white focus:ring-[#f97316]">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    maxLength={500}
                    rows={5}
                    className="resize-none border-[#333] bg-[#1a1a1a] text-white placeholder:text-gray-500 focus:border-[#f97316]"
                  />
            ...
            <div className="text-center">
              ...
              <p className="mt-4 text-sm text-gray-500">Shortlisted participants will be contacted via email</p>
            </div>
          </form>
        </div>
      </section>
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mb-12 text-center text-gray-400">
            Everything you need to know about SpeedUp and the application process
          </p>
          ...
          <Accordion type="single" collapsible className="space-y-3">
            {faqs.map((faq, index) => (
              <AccordionItem
                key={index}
                value={`item-${index}`}
                className="rounded-xl border border-[#333] bg-[#222] px-6"
              >
                <AccordionTrigger className="py-4 text-left text-[15px] font-medium hover:no-underline [&[data-state=open]]:text-[#f97316]">
                  {faq.question}
                </AccordionTrigger>
                <AccordionContent className="pb-4 text-sm text-gray-400">{faq.answer}</AccordionContent>
              </AccordionItem>
            ))}
          </Accordion>
      ...
      <footer className="border-t border-[#333] px-6 py-8">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <p className="text-sm text-gray-500">© 2026 SpeedUp. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
